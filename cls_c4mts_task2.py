...
# ResNet18 = resnet101(weights=ResNet101_Weights.IMAGENET1K_V1)

# ResNet18 = models.ViT_H_14_Weights(weights=ViT_H_14_Weights.IMAGENET1K_SWAG_E2E_V1)
...
# specify optimizer
optimizer = optim.AdamW(ResNet18.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01)
# scheduler = ExponentialLR(optimizer, gamma=0.9)
scheduler = lr_scheduler.MultiStepLR(optimizer, gamma=0.9, milestones=[20,30],)
